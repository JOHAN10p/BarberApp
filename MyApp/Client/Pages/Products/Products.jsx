...
const Products = () => {
  ...
  const prev = () => {
    ...
    if (prevIndex < 0) {
      setCurrentIndex(items1.length - 1);
    } else {
  ...
  const prev2 = () => {
    ...
    if (prevIndex2 < 0) {
      setCurrentIndex2(items2.length - 1);
    } else {
